	...
	<section class="section">
		<div class="container">
			...
			<div class="steps clearfix">
				<ul role="tablist">
					<li role="tab" class="first done"><a href="<?= $baseurl ?>SeccCardholderAddTemps/personalDetails">
			...
			<div class="row justify-content-center" data-aos="fade-up">
				<div class="col-lg-12">
					<?php echo $this->Form->create($seccCardholderAddTemp, ['id' => 'bank_dtl']) ?>
					<div class="card">
						<div class="card-body">
							...
							<div class="text-center">
								<?php
								echo  $this->Html->link("Previous", "/SeccCardholderAddTemps/personalDetails/", ["class" => "btn btn-warning text-white"]);
								echo '&emsp;' . $this->Form->button(__("Save Draft"), ["class" => "btn btn-success"]);
								if ($seccCardholderAddTemp->application_status >= 3) {
									echo '&emsp;' . $this->Html->link("Next", "/SeccCardholderAddTemps/additionalDetails/", ["class" => "btn btn-info text-white"]);
								}
								echo $this->Form->end();
								?>
							</div>
