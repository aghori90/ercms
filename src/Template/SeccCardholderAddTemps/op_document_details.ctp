...
<div class="steps clearfix">
    <ul role="tablist">
        ...
        <li role="tab" class="done" aria-disabled="false" aria-selected="true"><a href="<?= $baseurl ?>SeccCardholderAddTemps/opAddFamily">
                <span class="current-info audible"> </span>
                <div class="title"><span class="number">4</span> <span class="title_text">Add Family Member</span> </div>
            </a></li>
        <li role="tab" class="current" aria-disabled="false" aria-selected="true"><a href="<?= $baseurl ?>SeccCardholderAddTemps/opDocumentDetails"><span class="current-info audible"> </span>
...
<div class="main-card mb-3 card">
    <div class="card">
        ...
        <div class="card-body offset-md-1">
            ...
            <?php echo $this->Form->create($seccFamilyDocument, ['id' => 'document_dtl1', 'enctype' => 'multipart/form-data']) ?>
            <div class="form-group row">
                ...
                <?php if (array_key_exists("18", $SeccFamilyDocuments)) {
                    $document_path = DOC_ABS_PATH . $seccCardholderAddTemp->rgi_district_code . DS . $seccCardholderAddTemp->ack_no . DS . h($SeccFamilyDocuments['18']);
            ...
            <?php if ($seccCardholderAddTemp->is_bank == '1') { ?>

                <?php echo $this->Form->create($seccFamilyDocument, ['id' => 'document_dtl3', 'enctype' => 'multipart/form-data']) ?>
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label required font-weight-bold " for="name">Bank Passbook : </label>
                    <div class="col-sm-4">
            ...
            <?php if ($seccCardholderAddTemp->caste_id == 3 || $seccCardholderAddTemp->caste_id == 4 || $seccCardholderAddTemp->caste_id == 7) {
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label required font-weight-bold " for="name">Caste Certificate : </label>
                    <div class="col-sm-4">
            ...
            <?php if ($seccCardholderAddTemp->disability_status == 1) {
                echo $this->Form->create($seccFamilyDocument, ['id' => 'document_dtl4', 'enctype' => 'multipart/form-data']); ?>

                <div class="form-group row">
                    <label class="col-sm-3 col-form-label required font-weight-bold " for="name">Disability Certificate : </label>
                    <div class="col-sm-4">
            ...
            <?php if ($seccCardholderAddTemp->health_status == 1) {
                echo $this->Form->create($seccFamilyDocument, ['id' => 'document_dtl5', 'enctype' => 'multipart/form-data']); ?>

                <div class="form-group row">
                    <label class="col-sm-3 col-form-label required font-weight-bold " for="name">Health Certificate : </label>
                    <div class="col-sm-4">
            ...
            <?php if ($seccCardholderAddTemp->marital_status == 1) {
                echo $this->Form->create($seccFamilyDocument, ['id' => 'document_dtl6', 'enctype' => 'multipart/form-data']); ?>

                <div class="form-group row">
                    <label class="col-sm-3 col-form-label required font-weight-bold " for="name">Death Certificate : </label>
                    <div class="col-sm-4">
        ...
        <div class="text-center mb_10">
            <?php echo $this->Form->create($seccFamilyDocument, ['enctype' => 'multipart/form-data']) ?>
            <?php
            ...
            if ($seccCardholderAddTemp->application_status >= 6) {
                echo '&emsp;' . $this->Html->link("Next", "/SeccCardholderAddTemps/opPreview/", ["class" => "btn btn-info text-white"]);
            } ?>
...
<script type="text/javascript">
    ...
    function checkdoc() {
        ...
        <?php if ($seccCardholderAddTemp->is_bank == 1) { ?>if(!$('#view_passbook').length) {
            i.push("document_dtl3");
        }
    <?php } ?>
    <?php if ($seccCardholderAddTemp->caste_id == 3 || $seccCardholderAddTemp->caste_id == 4 || $seccCardholderAddTemp->caste_id == 7) { ?>if(!$('#view_caste').length) {
        i.push("document_dtl2");
    }
    <?php } ?>
    <?php if ($seccCardholderAddTemp->disability_status == 1) { ?>if(!$('#view_disability').length) {
        i.push("document_dtl4");
    }
    <?php } ?>
    <?php if ($seccCardholderAddTemp->health_status == 1) { ?>if(!$('#view_health').length) {
        i.push("document_dtl5");
    }
    <?php } ?>
    <?php if ($seccCardholderAddTemp->marital_status == 1) { ?>if(!$('#view_death').length) {
        i.push("document_dtl6");
    }
    <?php } ?>
    if (i.length === 0) {
        return true;
