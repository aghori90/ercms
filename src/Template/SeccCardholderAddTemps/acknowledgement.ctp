                                ...
                                <div style="background-color: #ffffff; border: dashed; 1px; padding: 20px;">
                                    ...
                                    <div class="card border-1 card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col col-sm-2 offset-sm-1">हस्ताक्षर </label>
                                            <div class="col col-sm-4" style="border-bottom: 2px dotted grey; padding: 20px;"></div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <tr>
                                                <td width="455" style="height:100%;">
                                                    <table style="border:hidden">
                                                        ...
                                                        <tr>
                                                            <td>ग्राम : <?php if($seccCardholderAddTemp->location_id == 2){echo  $seccCardholderAddTemp->secc_village_ward->name; }else{echo 'NA';}?></td>
                                                        </tr>
                                                        <tr>
                                                            <td>वार्ड संख्यां (शहरी क्षेत्र के लिए) : <?php if($seccCardholderAddTemp->location_id == 1){echo  $seccCardholderAddTemp->secc_village_ward->name; }else{echo 'NA';}?></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <table class="table table-bordered">
                                                <tr style="border-bottom: hidden" >
                                                    ...
                                                    <td style="text-align:left"><b>आवेदक के द्वारा समर्पि आवेदन में वर्णित तथ्यों को जांचोपरांत मैंने सही पाया / निम्नवर्णित कारण से सही नहीं पाया :-</b>
                                                        <br>
                                                        <?php echo  $this->Form->checkbox('priority', ['class' => 'priority', 'id' => 'priority', 'disabled' => 'disabled', 'value' => $inclusion->id, 'hiddenField' => false, "checked" => $disability_check]) . ' &nbsp;आवेदक समावेशन मानक (कंडिका संख्यां )-.................के आधार पर सुपात्र नहीं है।  <br />';
                                                        echo  $this->Form->checkbox('priority', ['class' => 'priority', 'id' => 'priority', 'disabled' => 'disabled', 'value' => $inclusion->id, 'hiddenField' => false, "checked" => $disability_check]) . ' &nbsp;आवेदक अपवर्जन  मानक (कंडिका संख्यां )-.................के आधार पर सुपात्र नहीं है। <br />'; ?>
                                                    </td>
                                                </tr>
