					...
					<div class="card">
						<div class="card-body">
							...
							<div class="text-center">
								...
								<?php
								echo  $this->Html->link("Previous", "/SeccCardholderAddTemps/bankDetails/", ["class" => "btn btn-warning text-white"]);
								...
								if ($seccCardholderAddTemp->application_status >= 6) {
									echo '&emsp;' . $this->Html->link("Next", "/SeccCardholderAddTemps/preview/", ["class" => "btn btn-info text-white"]);
								} ?>
