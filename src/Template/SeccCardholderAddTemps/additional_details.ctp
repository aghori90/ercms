	...
	<section class="section">
		<div class="container">
			...
			<div class="row justify-content-center" data-aos="fade-up">
				<div class="col-lg-12"> <?php echo $this->Form->create($seccCardholderAddTemp, ['name' => 'additional_dtl', 'id' => 'additional_dtl']) ?>
					<div class="card">
						<div class="card-body">
									...
									<div class="col-sm-10 ">
										...
										foreach ($inclusion_criterias as $inclusion) {
											...
											if (($seccCardholderAddTemp->$key != '') && ($seccCardholderAddTemp->$key == '1' || $seccCardholderAddTemp->$key == '3')) {
												...
												if ($hof_gender_id != '') {
													if ($hof_gender_id->gender_id == 3 && $key == 'marital_status') {
														$check = 'checked';
													} else {
														$check = '';
													}
							...
							<div class="text-center">
								...
								if ($seccCardholderAddTemp->application_status >= 4) {
									echo '&emsp;' . $this->Html->link("Next", "/SeccCardholderAddTemps/addFamily/", ["class" => "btn btn-info text-white"]);
								} ?>
								<?= $this->Form->end() ?>
							</div>
						</div>
