...
<div class="steps clearfix">
    <ul role="tablist">
        <li role="tab" class="first done"><a href="<?= $baseurl ?>SeccCardholderAddTemps/opPersonalDetails">
                <div class="title"><span class="number">1</span> <span class="title_text">Personal Details</span> </div>
            </a></li>
        <li role="tab" class="current" aria-disabled="false" aria-selected="true"><a href="<?= $baseurl ?>SeccCardholderAddTemps/bankDetails" style="pointer-events: none !important;"><span class="current-info audible"> </span>
...
<br>
<?= $this->Flash->render() ?>
<?php echo $this->Form->create($seccCardholderAddTemp, ["autocomplete" => "off", "id" => "opbank_dtl"]) ?>
...
<div class="main-card mb-3 card">
    <div class="card">
        ...
        <div class="card-body offset-md-2">
            ...
            <?php if ($seccCardholderAddTemp->is_lpg == 1) {
                $lpg_disp = '';
            } else {
                $lpg_disp = 'none';
            } ?>
            <div id="lpg_detail" style="display:<?= $lpg_disp ?>">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <?php echo $this->Form->control("lpg_company", ["options" => ["1" => "HP Gas (HPCL)", "2" => "BharatGas (BPCL)", "3" => "Indane (IOCL)"], "class" => "form-control form-control-sm", "label" => false, "empty" => "Select LPG Connection"]); ?>
                    </div>
                </div>
                <div class="form-group row">
            ...
            <div id="bank_detail" style="display:<?= $bank_disp ?>">
                <div class="form-group row">
                 ...
                 <!-- The Modal --> 
 <div class="modal fade" id="ifscModal"  role="" style="margin-top: 50px;">
        ...
        <div class="text-center mb_10">
            <?php
            echo  $this->Html->link("Previous", "/SeccCardholderAddTemps/opPersonalDetails/", ["class" => "btn btn-warning text-white"]);
            echo '&emsp;' . $this->Form->button(__("Save Draft"), ["class" => "btn btn-success"]);
            if ($seccCardholderAddTemp->application_status >= 3) {
                echo '&emsp;' . $this->Html->link("Next", "/SeccCardholderAddTemps/opAdditionalDetails/", ["class" => "btn btn-info text-white"]);
            }
