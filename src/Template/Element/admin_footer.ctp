	...
	<div class="app-footer">
		<div class="app-footer__inner">
			<div class="app-footer-left">
				<strong> Design & Developed by NIC JHARKHAND</strong>
			</div>
			<div class="app-footer-right">
				<ul class="header-megamenu nav">
					<!-- <li class="nav-item">
						<a data-placement="top" rel="popover-focus" data-offset="300" data-toggle="popover-custom" class="nav-link">Quick Link
