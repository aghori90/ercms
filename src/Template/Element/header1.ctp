...
<div id="preloader"></div>
	...
	<header id="header" class="fixed-top">
		<div class="container d-flex align-items-center">
			...
			<h1 class="logo mr-auto"><a href="<?= $this->request->getAttribute("webroot") ?>SeccCardholders/index"><span> <i class="fa fa-home"></i> Ration Card </span>Management System</a></h1>
        ...
        <a href="#" class="linkedin"><i class="icofont-linkedin"></i></i></a>-->
					<a href="<?= $this->request->getAttribute("webroot") ?>SeccCardholders/logout"><button class="btn bg-green text-white"><i class="fa fa-sign-out-alt"></i>&ensp;Logout </button></a>
