...
<div class="main-card mb-3 card">
	<?php echo $this->Form->create(false, ['id' => 'bso_application_view']) ?>
	<?php if (!empty($seccCardholderAddTemp)) { ?>
		<div class="card">
			...
			<div class="text-left col-sm-10">Request For:- New Application for Ration Card </div>
				<div class="col-sm-2 text-right px-4""><?php echo  $this->Html->link("Back", "/NfsaCardholders/bsoApplicationList/" . base64_encode(1), ["class" => "btn btn-warning text-white"]); ?></div>
			</div>
			<div class="card-body">
				<div class="form-group row">
					<div class="col-sm-12 text-center">
						<h4><strong>Acknowledgement No : </strong><span style="color:#009933"><?= $ack_no ?></span></h4>
					</div>
				</div>
		 ...
		 <td><?php
					...
					<?php
						...
						<div class="card-body offset-md-1">
							...
							<?php if ($seccCardholderAddTemp['is_bank'] == 1 && $document_status['bank_doc'] == 0) { ?>
								...
								{
								    $document_path = DOC_NFSA_PATH . $rgi_district_code . DS . $ack_no . DS . h($SeccFamilyDocuments['13']);
								    if (!file_exists($document_path))
								    {
								        $document_path = "img/fnf.jpg";
								    } ?>
							...
							<?php if ($seccCardholderAddTemp['caste_id'] == 3 || $seccCardholderAddTemp['caste_id'] == 4 || $seccCardholderAddTemp['caste_id'] == 7)
								...
								<div class="form-group row">
								    ...
								    {
								        $document_path = DOC_NFSA_PATH . $rgi_district_code . DS . $ack_no . DS . h($SeccFamilyDocuments['14']);
								        if (!file_exists($document_path))
								        {
								            $document_path = "img/fnf.jpg";
								        } ?>
							...
							<?php if ($seccCardholderAddTemp['disability_status'] == 1 && $document_status['disablility_doc'] == 0)
								...
								<div class="form-group row">
								    ...
								    {
								        $document_path = DOC_NFSA_PATH . $rgi_district_code . DS . $ack_no . DS . h($SeccFamilyDocuments['16']);
								        if (!file_exists($document_path))
								        {
								            $document_path = "img/fnf.jpg";
								        } ?>
							...
							<?php if ($seccCardholderAddTemp['health_status'] == 1 && $document_status['health_doc'] == 0)
								...
								<div class="form-group row">
								    ...
								    {
								        $document_path = DOC_NFSA_PATH . $rgi_district_code. DS . $ack_no . DS . h($SeccFamilyDocuments['15']);
								        if (!file_exists($document_path))
								        {
								            $document_path = "img/fnf.jpg";
								        } ?>
							...
							<?php if ($seccCardholderAddTemp['marital_status'] == 1 && $document_status['death_doc'] == 0)
								...
								<div class="form-group row">
								    ...
								    {
								        $document_path = DOC_NFSA_PATH . $rgi_district_code . DS . $ack_no . DS . h($SeccFamilyDocuments['17']);
								        if (!file_exists($document_path))
								        {
								            $document_path = "img/fnf.jpg";
								        } ?>
						...
						<div class="text-center">
							<?php							
							echo  $this->Html->link("Back", "/NfsaCardholders/bsoApplicationList/", ["class" => "btn btn-warning text-white"]); ?>
						</div>
					...
					<div class="text-center">
						<?php
						echo $this->Form->control('application_id', ['type' => 'hidden']);
						echo $this->Form->control('nfsa_cardholder_add_temp_id', ['type' => 'hidden']);
						?>
