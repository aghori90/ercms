...
echo $this->Form->create('false', ['action' =>'bsoApplicationList']); ?>
...
<table width="60%" style="margin:auto;margin-top: 2%;"  class="table-condensed">
    ...
    <tr>
        ...
        <td>
        <label><?php echo $blockName;?></label>
        
        </td>			
    </tr>
    <tr>
        <td>Village</td>
        <td><?php echo $this->Form->select('rgi_village_code',$SeccVillageWards,['class'=>'form-control','empty'=>'-----select-----']); ?></td>			
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?php 
         $activity_flag=['0'=>'Pending','1'=>'Approve','2'=>'rejected'];
