		...
		<div class="container">
			...
			<div class="steps clearfix">
				<ul role="tablist">
					...
					<li role="tab" class="current" aria-disabled="false" aria-selected="true"><a href="<?= $baseurl ?>NfsaCardholderTemps/addFamily">
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="card-body">
								...
								<?php if ($nfsaFamilyMemberCount >= 10) : ?>
								...
								<?php endif;
								if ($nfsaFamilyTemp->hasErrors() == true) : $disp = '';
								else : $disp = 'none';
								endif; ?>
								...
								<div id="member" style="display:<?= $disp ?>">
									...
									<div class="card">
										...
										<?php echo $this->Form->create($nfsaFamilyTemp, ['id' => 'add_family_members', 'enctype' => 'multipart/form-data']) ?>
										...
										<div class="card-body offset-md-2">
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													...
													<script language="javascript">
														CreateCustomHindiTextBox("name_sl", "<?php if ($nfsaFamilyTemp->name_sl != '') {
																										echo $nfsaFamilyTemp->name_sl;
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													...
													<script language="javascript">
														CreateCustomHindiTextBox("fathername_sl", "<?php if ($nfsaFamilyTemp->fathername_sl != '') {
																										echo $nfsaFamilyTemp->fathername_sl;
																									} ?>", "form-control form-control-sm", true);
													</script>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													...
													<?php
													if (array_key_exists('disability_status', $nfsaCardholderTemp->getErrors())) {
														foreach ($nfsaCardholderTemp->getErrors()['disability_status'] as $key => $value) {
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													...
													<?php
													if (array_key_exists('marital_status', $nfsaCardholderTemp->getErrors())) {
														foreach ($nfsaCardholderTemp->getErrors()['marital_status'] as $key => $value) {
															echo '<div class="error-message">' . $value . '</div>';
														}
													} ?>
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													...
													<?php
													if (array_key_exists('health_status', $nfsaCardholderTemp->getErrors())) {
														foreach ($nfsaCardholderTemp->getErrors()['health_status'] as $key => $value) {
															echo '<div class="error-message">' . $value . '</div>';
														}
													} ?>
												</div>
								...
								<?php
								$sl = 0;
								foreach ($nfsaFamilyMember as $member) {
									$sl++; ?>
									<div class="card">
										<div class="card-body border-left border-primary">
											...
											<?php
											foreach ($member->nfsa_family_document_temps as $doc) {
								...
								<div class="text-center">
									<?php
									echo  $this->Html->link("Previous", "/NfsaCardholderTemps/additionalDetails/", ["class" => "btn btn-warning text-white"]);
									...
									if ($nfsaCardholderTemp->application_status >= 5) {
										echo '&emsp;' . $this->Html->link("Next", "/NfsaCardholderTemps/documentDetails/", ["class" => "btn btn-info text-white"]);
									} ?>
									<?= $this->Form->end() ?>
								</div>
							</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$(".editMember").click(function() {
			...
			var url = '<?= Router::url(array('controller' => 'NfsaCardholderTemps', 'action' => 'getMemberDetails', '_full' => true)) ?>';
