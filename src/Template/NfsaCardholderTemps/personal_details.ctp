...
<main id="main">
	...
	<section class="section">
		<div class="container">
			<?php
			$percentage = round((($nfsaCardholderTemp->application_status) / 6) * 100);
			?>
			<div class="progress">
			...
			<div class="row justify-content-center" data-aos="fade-up">
				...
				<div class="col-lg-12">
					<?php echo $this->Form->create($nfsaCardholderTemp, ['id' => 'personal_details']) ?>
					<div class="card">
						<div class="card-body">
							...
							<div class="card-body offset-md-2">
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<?php echo $nfsaCardholderTemp->secc_district->name; ?>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<?php echo $nfsaCardholderTemp->secc_block->name; ?>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<?php echo $nfsaCardholderTemp->secc_village_ward->name; ?>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<?php echo $nfsaCardholderTemp->name; ?>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<?php echo $nfsaCardholderTemp->name_sl; ?>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<?php echo $nfsaCardholderTemp->fathername; ?>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<?php echo $nfsaCardholderTemp->fathername_sl; ?>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<?php echo $nfsaCardholderTemp->mobileno; ?>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										...
										<script language="javascript">
											CreateCustomHindiTextBox("mothername_sl", "<?php if($nfsaCardholderTemp->mothername_sl!=''){echo $nfsaCardholderTemp->mothername_sl;}?>", "form-control form-control-sm", true);
										</script>
									</div>
								</div>
							...
							<div class="text-center">
								...
								if ($nfsaCardholderTemp->application_status >= 2) {
									echo '&emsp;' . $this->Html->link("Next", "/NfsaCardholderTemps/bankDetails/", ["class" => "btn btn-info text-white"]);
								}
								echo $this->Form->end();
								?>
							</div>
