			...
			<div class="card-body">
				...
				if ($seccCardholderAddTemp->is_bank == 0) {
					...
					$document_status->bank_doc = 1;
			         ...
			         if($seccCardholderAddTemp->marital_status=='3' || $seccCardholderAddTemp->marital_status='4')
				{
				$a=1;
				}
				else 
				...
				$document_no = $seccCardholderAddTemp->is_bank + $caste_id + $a + $seccCardholderAddTemp->disability_status + $seccCardholderAddTemp->health_status;
				...
				//echo $document_uploaded.'-'.$document_no;die;
				?>
