	...
	<?php if (!empty($seccCardholderAddTemp)) { ?>
		<div class="card">
			...
			<div class="card-body">
				...
				<?php
				if ($seccCardholderAddTemp->non_gov == '1' || $seccCardholderAddTemp->above_sixty == '1' || $seccCardholderAddTemp->marital_status == '1' || $seccCardholderAddTemp->disability_status == '1' || $seccCardholderAddTemp->health_status == '1' || $seccCardholderAddTemp->pvtg == '1' || $seccCardholderAddTemp->old_alone == '1' || $seccCardholderAddTemp->caste_id == '3' || $seccCardholderAddTemp->caste_id == '4' || $seccCardholderAddTemp->caste_id == '7') { ?>
					<div class="form-group bg-info text-center text-white">
				...
				// debug($seccCardholderAddTemp->is_bank);
				// debug($caste_id);
				// debug($seccCardholderAddTemp->marital_status);
				// debug($seccCardholderAddTemp->disability_status);
				// debug($seccCardholderAddTemp->health_status);debug($document_status);
