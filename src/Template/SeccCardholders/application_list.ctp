...
echo $this->Form->create('false', ['action' => 'bsoNewRationApproval', 'id' => "submitForm"]); ?>
<div class="card">
    ...
    <div class="card-body">
        <?php if (!empty($seccCardholderAddTemp)) { ?>
			...
			<th>AppliedDate</th>	
				...
				<td>
                                    <?php echo $villageList[$applicant->rgi_village_code];?>
                                </td>
				<td>
				<?php echo $applicant->family_count;?>
				</td>	
				<td>
                                <?php echo date('d-m-Y',strtotime($applicant->created));?>
                                </td>
