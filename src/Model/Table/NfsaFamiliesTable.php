 ...
 * @property \App\Model\Table\NfsaFamilyAddTempsTable&\Cake\ORM\Association\BelongsTo $NfsaFamilyAddTemps
 ...
 *
 * @method \App\Model\Entity\NfsaFamily get($primaryKey, $options = [])
 * @method \App\Model\Entity\NfsaFamily newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\NfsaFamily[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\NfsaFamily|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\NfsaFamily saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\NfsaFamily patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\NfsaFamily[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\NfsaFamily findOrCreate($search, callable $callback = null, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class NfsaFamiliesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('NfsaFamilyAddTemps', [
            'foreignKey' => 'nfsa_family_add_temp_id',
            'joinType' => 'INNER',
        ]);
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['nfsa_family_add_temp_id'], 'NfsaFamilyAddTemps'));
