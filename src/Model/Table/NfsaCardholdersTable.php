 ...
 * @property \App\Model\Table\NfsaCardholderAddTempsTable&\Cake\ORM\Association\HasMany $NfsaCardholderAddTemps
 * @property \App\Model\Table\NfsaFamiliesTable&\Cake\ORM\Association\HasMany $NfsaFamilies
 * @property \App\Model\Table\NfsaFamilyAddTempsTable&\Cake\ORM\Association\HasMany $NfsaFamilyAddTemps
 *
 * @method \App\Model\Entity\NfsaCardholder get($primaryKey, $options = [])
 * @method \App\Model\Entity\NfsaCardholder newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\NfsaCardholder[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\NfsaCardholder|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\NfsaCardholder saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\NfsaCardholder patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\NfsaCardholder[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\NfsaCardholder findOrCreate($search, callable $callback = null, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class NfsaCardholdersTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('nfsa_cardholders');
        ...
        $this->hasMany('NfsaCardholderAddTemps', [
            'foreignKey' => 'nfsa_cardholder_id',
        ]);
        $this->hasMany('NfsaFamilies', [
            'foreignKey' => 'nfsa_cardholder_id',
        ]);
