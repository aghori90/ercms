 ...
 */
class NfsaFamilyTempsTable extends Table
{
	/**
	 * Initialize method
	 *
	...
	public function initialize(array $config)
	{
		...
		$this->setTable('nfsa_family_temps');
		$this->setDisplayField('name');
		$this->setPrimaryKey('id');

		$this->addBehavior('Timestamp');

		$this->belongsTo('NfsaFamilies', [
		...
		$this->hasMany('NfsaFamilyDocumentTemps', [
	...
	public function validationEditmember(Validator $validator)
	{
		...
		$validator
			//->requirePresence('aadhar_doc', 'create')
           	//->notEmptyString('aadhar_doc')
			->allowEmptyFile('aadhar_doc', 'update')
			->add('aadhar_doc', [
				'uploadError' => [
					'rule' => 'uploadError',
					'message' => __('The document upload failed.'),
	...
	public function validationAddNewMember(Validator $validator)
	{
		$validator
			->uuid('id')
			->allowEmptyString('id', null, 'create');
	...
	public function validationChangeUid(Validator $validator)
	{
		$validator
			->uuid('id')
			->allowEmptyString('id', null, 'create');
