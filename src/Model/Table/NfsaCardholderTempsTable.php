 ...
 */
class NfsaCardholderTempsTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('nfsa_cardholder_temps');
        ...
        $this->belongsTo('SeccDistricts', [
            ...
            'joinType' => 'LEFT',
            'conditions' => array(
                'NfsaCardholderTemps.rgi_district_code = SeccDistricts.rgi_district_code'
            ),
        ]);
        $this->belongsTo('SeccBlocks', [
            ...
            'joinType' => 'LEFT',
            'conditions' => array(
                'NfsaCardholderTemps.rgi_block_code = SeccBlocks.rgi_block_code'
            ),
        ]);
        $this->belongsTo('Panchayats', [
            ...
            'joinType' => 'LEFT',
            'conditions' => array(
                'NfsaCardholderTemps.panchayat_id = Panchayats.id'
            ),
        ]);
        ...
        $this->belongsTo('SeccVillageWards', [
            ...
            'joinType' => 'LEFT',
            'conditions' => array(
                'NfsaCardholderTemps.rgi_village_code = SeccVillageWards.rgi_village_code'
            ),
        ]);
    ...
    /* public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('panchayat_id');
            //->requirePresence('panchayat_id');
    ...
    public function validationChangeHof(Validator $validator)
    {
        ...
        $validator
            //->scalar('mobileno')
            //->maxLength('mobileno', 10)
            ->maxLength('mobileno', 10, 'Mobile No need to be maximum 10 characters long.', !empty($context['data']['mobileno']))
            ->minLength('mobileno', 10, 'Mobile No need to be at least 10 characters long.', !empty($context['data']['mobileno']))
            ->notEmptyString('mobileno', 'This field is required', function ($context) {
                return !empty($context['data']['mobileno']);
            })
    ...
    public function validationRegister(Validator $validator)
    {
        ...
        $validator
            ...
            ->minLength('uid', 12)
            ->notEmptyString('uid')
            ->numeric( 'uid' , 'Please enter uid in integers' );
    ...
    public function validationBank(Validator $validator)
    {
        ...
        $validator
            ->notEmptyString('lpg_company', 'This field is required', function ($context) {
                return ($context['data']['is_lpg'] == 1);
            })
