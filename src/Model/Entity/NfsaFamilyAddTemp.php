...
/**
 * NfsaFamilyAddTemp Entity
 *
 * @property string $id
 * @property string|null $nfsa_secc_family_id
 ...
 * @property string|null $nfsa_cardholder_add_temp_id
 ...
 * @property float|null $ack_no_ercms
 ...
 *
 * @property \App\Model\Entity\NfsaSeccFamily $nfsa_secc_family
 * @property \App\Model\Entity\NfsaCardholder $nfsa_cardholder
 * @property \App\Model\Entity\NfsaCardholderAddTemp $nfsa_cardholder_add_temp
 ...
 */
class NfsaFamilyAddTemp extends Entity
{
    /**
    ...
    protected $_accessible = [
        'nfsa_secc_family_id' => true,
        'rationcard_no' => true,
        'ahl_tin' => true,
        'hhd_unique_no' => true,
        'nfsa_cardholder_id' => true,
        'nfsa_cardholder_add_temp_id' => true,
        ...
        'dep_remarks' => true,
        'requestedBy' => true,
        'nfsa_secc_family' => true,
        'nfsa_cardholder' => true,
        'nfsa_cardholder_add_temp' => true,
        'relation' => true,
        'gender' => true,
        'bank_master' => true,
        'branch_master' => true,
