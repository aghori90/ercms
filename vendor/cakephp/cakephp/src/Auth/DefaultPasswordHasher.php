...
class DefaultPasswordHasher extends AbstractPasswordHasher
{
    ...
    public function hash($password)
    {
       /* return password_hash(
			...
			//debug($request=$this->request->data);die;
    ...
    {
//        debug($this->hash($hashedPassword)).'<br/>';
//                               echo  $password.'<br/>';
                                $hashedPassword1=$this->hash($hashedPassword);
                                if($password === $hashedPassword1)
                                {
//                                       die('hi');
                                    return true;
...
//                                if($password === (string)$hashedPassword1)
//                                {
////                                       die('hi');
//                                    return true;
//                                 
