 ...
 * SeccFamiliesFixture
 */
class SeccFamiliesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'impdsRationcardMemberId' => ['type' => 'string', 'length' => 15, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'nfsa_head' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'pfmsRiceId' => ['type' => 'string', 'length' => 25, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'pfmsKoilId' => ['type' => 'string', 'length' => 25, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'uidVaultFlag' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'maskUid' => ['type' => 'string', 'length' => 12, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'ekycFlag' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'RationcardIndex' => ['type' => 'index', 'columns' => ['rationcard_no'], 'length' => []],
            'cardIdIndex' => ['type' => 'index', 'columns' => ['secc_cardholder_id'], 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => '96efb987-e1e1-4718-ad88-1a350a2fb9cd',
                'rationcard_no' => 'Lorem ipsu',
                'impdsRationcard' => 'Lorem ipsu',
                'impdsRationcardMemberId' => 'Lorem ipsum d',
                'ahl_tin' => 'Lorem ipsum dolor sit amet',
                'hhd_unique_no' => 'Lorem ipsum dolor sit amet',
                'secc_cardholder_id' => 'd8e3d433-2484-447b-92f5-3306ace63ea4',
                'rgi_district_code' => 'L',
                'rgi_block_code' => 'Lore',
                ...
                'nfsa_head' => 1,
                'uidFlag' => 1,
                'created' => '2020-07-27 06:46:21',
                'modified' => '2020-07-27 06:46:21',
                'created_by' => 1,
                'modified_by' => 1,
                ...
                'dbtFlag' => 1,
                'pfmsRiceId' => 'Lorem ipsum dolor sit a',
                'pfmsKoilId' => 'Lorem ipsum dolor sit a',
                'uidVaultFlag' => 1,
                'maskUid' => 'Lorem ipsu',
                'ekycFlag' => 1,
            ],
