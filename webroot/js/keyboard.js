...
function CreateCustomHindiTextBox(elementId,defaultValue,textBoxClass,showHelp)
{
	hinTextBoxObj= new TextBoxInput();
	hinTextBoxObj.Id=elementId;
	hinTextBoxObj.Name=elementId;
	...
	hinTextBoxObj.Class=textBoxClass;
	if(!showHelp)
	{
		hinTextBoxObj.Logo=false; 
	}
...
{
	//alert("in CreateHindiTextBoxSelectedParam: Id = "+textBoxParam.Class);
